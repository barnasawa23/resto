...
// import components
import { Newsletter, Copyright, Socials } from '../../components';
...
const Footer = () => {
  ...
  return (
    <footer className='bg-dark relative top-96 z-20 lg:bg-transparent lg:min-h-[620px] lg:bg-footer lg:bg-center lg:bg-no-repeat pt-28 lg:pt-32'>
      <div className="container mx-auto h-full">
        ...
        <motion.div 
          ...
          {/* info */}
          <motion.div variants={fadeIn('up', 'tween', 0.6, 1.6)} className='flex flex-col lg:flex-row lg:gap-x-[130px] gap-y-12 lg:gap-y-8 lg:mb-12'>
            
            {/* contact */}
            <div className='flex-1 lg:max-w-[170px]'>
              <div className="capitalize text-[28px] lg:text-[22px] font-normal text-white font-primary mb-[22px]">
                {contact.title}
              </div>
