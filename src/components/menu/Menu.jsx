...
const Menu = () => {
  ...
  return (
    <section className='min-h-[780px]'>
      ...
      {/* backgrund */}
      <div className='bg-yellow-200 h-[780px] bg-menu absolute w-full max-w-[1800px] -z-0'></div>
      ...
      <div className='relative z-10 top-72 lg:top-52'>
        ...
        >
          ...
          >
            <img src={modelImg} alt="Menu title line" />
          </motion.div>
        </motion.div>
      </div>
      ...
      <motion.div 
        ...
        <div className='container mx-auto'>
          <div className='lg:-mt-24 min-h-[598px] z-30 mb-8 md:mb-4 xl:mb-16'>

          {/* grid */}
            <div className='grid grid-cols-1 lg:grid-cols-4 min-h-[598px]'>
              {
                  ...
                  return (
                    <div key={index}>
                      <div className='flex flex-row lg:flex-col h-full'>
                        {/* image */}
                        {/* reverse order for the first image */}
                        <div className={`w-[45%] md:w-auto ${index === 1 || index === 3 ? 'lg:order-1' : 'order-none'}`}>
                          <img src={image} alt="" />
                        </div>

                        {/* text */}
                        <div className='bg-[#fff3e4] flex-1 flex flex-col justify-center px-6 lg:p-12 lg:max-h-[258px] xl:max-h-max'>
                          <div className='text-center'>
                            <div className='text-xl font-semibold text-dark xl:text-2xl'>{name}</div>
                            <div className='my-1 text-[28px] lg:text-[48px] lg:my-6 text-accent font-semibold'>{price}</div>
                            <div>{description}</div>
                          </div>
                        </div>
                      </div>
