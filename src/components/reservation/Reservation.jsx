    ...
    <section className='relative top-96 z-30 pb-20 lg:py-[100px]'>
      <div className="container mx-auto">
        ...
        >
          ...
          >
            <img src={modelImg} alt="ligne pic" />
          </motion.div>
        </motion.div>
        ...
        >
          <div className='flex flex-col lg:flex-row gap-y-4 items-center justify-between mb-8'>
            ...
            <div>
              ...
              <input type='text'
                placeholder='10:00 am/pm' 
                className='input placeholder:text-grey' 
            ...
            <div>
              ...
              <input type="text" placeholder='1' className='input placeholder:text-grey' />
            </div>
          </div>
          {/* button */}
