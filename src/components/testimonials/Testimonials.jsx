...
const Testimonials = () => {
  ...
  return (
    <section className='bg-testimonial bg-cover bg-no-repeat relative top-[348px] lg:top-[398px] z-10 h-[800px] pt-[60px] md:pt-[120px]'>
      <div className='container mx-auto'>
        ...
        >
          ...
          <div className='mb-12'>
            <img src={modelImg} alt="underline pic" />
          </div>
        </motion.div>
        {/* Slider Carousel */}
        <motion.div 
